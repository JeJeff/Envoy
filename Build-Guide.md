...
It can be a good idea to make sure the Pro Micro is in good condition before soldering it in place, so connect it to your computer and [flash your firmware of choice](Firmware/Firmware-Flashing.md) (Envoy Vial firmware recommended).
